...
export const WordCard = ({ word, translation, pos, grammarNote, example, contextSentence, bookTitle, language, onSpeak, onClose }: WordCardProps) => {
  ...
  return (
    <div className="absolute z-50 bg-white dark:bg-[#1C1C1C] p-5 rounded-xl shadow-2xl border border-gray-200 dark:border-white/20 w-80 text-left top-full mt-2 left-0 font-sans">
      ...
      <div className="text-xs text-gray-600 dark:text-gray-400 italic mb-5 leading-relaxed">
        "{example}"
      </div>
